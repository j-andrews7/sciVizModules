...
km_survival_single <- data.frame(
    # Columns ordered so that col[1] = time and col[2] = survival, enabling
    # the position-based defaults in survivalCurvePlotInputsUI to work without
...
group1 <- data.frame(
    # Columns ordered so that col[1] = time and col[2] = survival.
