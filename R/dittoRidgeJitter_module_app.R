#' Create a standalone Shiny app for the dittoRidgeJitter module
#'
#' This function generates a Shiny application with modular ridge/jitter-plot
...
#' configuring and displaying an interactive [dittoSeq::dittoRidgeJitter()].
#'
...
#'
#' @seealso [sciVizModules::dittoRidgeJitterInputsUI()], [sciVizModules::dittoRidgeJitterOutputUI()],
#' [sciVizModules::dittoRidgeJitterServer()], [sciVizModules::example_sce]
#'
#' @export
...
dittoRidgeJitterApp <- function(object_list = NULL) {
    ...
    .ditto_module_app(
        ...
        output_ui_fn = dittoRidgeJitterOutputUI,
        server_fn    = dittoRidgeJitterServer,
        object_list  = object_list,
        title        = "Modular RidgeJitter"
    )
}
